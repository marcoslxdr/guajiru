...
**Design context (impeccable):** `PRODUCT.md` (register `brand`) + `DESIGN.md` (tokens + North Star “Lagoa em Movimento”).

**Brand colors:** `#5F9235`, `#C5D14D`, `#DD8FB8`, `#B7728A`. Line-height 1.25.

**Content editing:** Painel `/admin` (posts, modalidades, transparência + `site_settings`) com Supabase Auth. Fallback: Table Editor + Storage bucket `club-assets`.
